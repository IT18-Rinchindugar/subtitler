      ...
      >
        ...
        <div className="container flex-1 flex flex-col items-center justify-center px-2 md:px-0">
          ...
          <p className="mx-0 md:mx-16 text-center text-balance mt-8 md:mt-4 text-gray-400 text-base md:text-xl">
            Upload a video to get automatic AI transcription or translation and
          ...
          <div className="mt-6 md:mt-8 flex flex-col md:flex-row gap-3 md:gap-6 w-full md:w-auto md:justify-between mx-auto max-w-[34rem]">
            ...
            <button
              onClick={open}
              className="mx-auto md:mx-0 w-full md:w-auto outline-none focus-visible:ring ring-orange-500 ring-offset-zinc-900 ring-offset-2 rounded-lg bg-orange-600 inline-flex items-center justify-center px-6 py-3 font-medium"
            >
              Let's go!
            </button>
          </div>
